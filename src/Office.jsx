...
const Office = () => {
  ...
  const total =
    Number(agrValue) + Number(gst) + Number(stampDuty) + Number(registration);
  const total2 =
    Number(agrValue2) +
    Number(gst2) +
    Number(stampDuty2) +
  ...
  const MnthRent = Rent * SlableArea;
  ...
  return (
    <div className="real-estate-calculator-container">
      <h1>Potential ROI Calculator(Office)</h1>
        ...
        <div className="financial-three-year-overview">
          ...
          <table>
            ...
            <tbody>
              ...
              <tr>
                <td>IRR (3 years)</td>
                <td>{IRRthree.toFixed(2)} %</td>
                <td>{IRRthree2.toFixed(2)} %</td>
              </tr>
              <tr>
                <td>ROI</td>
